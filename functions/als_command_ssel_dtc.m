function [r2,copt,sopt]=als_command_ssel_dtc(d,x0,nit,tolsigma,ssel,csel,isp,vclos1,vclos2);
...
if nargin<8 & nexp==1,isp=ones(1,nsign);end
if nargin<8 & nexp>1,isp=ones(nexp,nsign);end
